...
if($arr_vidrabot['name'] == "Другое"){
 ?>
	...
	<input class="form-control form-control" type="text" name="new_name" placeholder="<?=$arr_vidrabot['name'] ?>"
		value="<?=$arr_vidrabot['name'] ?>" aria-label="Количество">
	<?
}else{
   ?>
...
?>">
	...
	<div class="col-auto">
		<input name="count" class="form-control form-control" type="text" name="count"
			placeholder="<?=$arr_vidrabot['count'] ?>" value="<?=$arr_vidrabot['count'] ?>" aria-label="Количество">
	</div>
	<div class="d-grid">
