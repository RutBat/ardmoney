...
<div style="text-align: center;">
	...
	<div style="padding: 30px 30px 20px;color: black;font-weight: 500;">
		...
		Если по каким то причинам забыли почту то напишите администратору в <a href="https://rutbat.t.me">Telegram</a>.
	</div>
</div>
<form style="padding: 20px;" method="GET" action="doreg.php">
	<label for="mail"></label><input type="email" autocomplete="off" id="mail" name="email" class="form-control" required
...
<li class="list-group-item">
	<form method="POST" action="auth_obr.php">
		<div class="m-3">
			<div style="text-align: center;">Для пользования сервисом авторизуйтесь или зарегистрируйтесь под своей
				учетной записью
			</div>
			<br>
			<label for="exampleInputlogin"></label><input name="login" id="exampleInputlogin" type="text" class="form-control"
				placeholder="Введите логин">
		</div>
		<div class="m-3">
			<label for="exampleInputPassword1"></label><input name="pass" type="password" class="form-control"
