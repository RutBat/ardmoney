...
">';
        ...
        $access = $row['access_date'];
				$id = $row['id'];
if($region == "01 - Север/Центр"){$bg_color = "#7fff0038";}
if($region == "02 - Восток"){$bg_color = "#816ecd38";}
if($region == "03 - Офис"){$bg_color = "#cd386269";}
if($region == "04 - Юго-Восток"){$bg_color = "#9f471d87";}
if($region == "05 - Новый мир"){$bg_color = "#85625287";}
if($region == "06 - Партизаны"){$bg_color = "#52856487";}
if($region == "07 - Юго-Запад"){$bg_color = "#47cd7687";}
if($region == "08 - Чистенькое"){$bg_color = "#63a11e87";}
if($region == "09 - Запад"){$bg_color = "#a11e9787";}
if($region == "10 - Москольцо"){$bg_color = "#74d4e387";}
if($region == "071 - Бахчисарай"){$bg_color = "#dfa46787";}
if($region == "12 - Зуя"){$bg_color = "#f9461187";}
if($region == "Проверочный регион"){$bg_color = "#4af91187";}
